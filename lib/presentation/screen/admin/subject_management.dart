...
class _SubjectManagementState extends State<SubjectManagement> {
                  ...
                  child: Padding(
                    ...
                    child: controller.isLoading
                        ...
                        : Builder(builder: (context) {
                            final all = controller.subjects.where((subject) {
                              ...
                              children: [
                                Expanded(
                                  child: DataTable2(
                                    ...
                                    rows: pageItems.map((subject) {
                                      return DataRow2(
                                        cells: [
                                          DataCell(Text(subject.subjectId?.toString() ?? 'N/A')),
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  IconButton(
                                                    ...
                                                    onPressed: () => _showDeleteConfirmDialog(context, subject),
                                                  ),
                                                ],
                                              ),
                                            ),
  ...
  void _showDeleteConfirmDialog(BuildContext context, Subject subject) {
    final outerContext = context;
    showDialog(
      context: outerContext,
      builder: (dialogCtx) => AlertDialog(
        title: const Text('Xác nhận xóa'),
        content: Text('Bạn có chắc chắn muốn xóa môn học "${subject.subjectName}"?'),
        actions: [
          TextButton(
            ...
            onPressed: () async {
              ...
              try {
                if (subject.subjectId != null) {
                  ok = await outerContext.read<AppController>().deleteSubject(subject.subjectId!);
                }
              } catch (e) {
                errorMessage = e.toString().replaceFirst('Exception: ', '');
              }
              ...
              _showSnack(outerContext, ok ? 'Xóa môn học thành công' : errorMessage, ok);
            },
