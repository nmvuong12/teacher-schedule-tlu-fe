...
class _SessionFormState extends State<SessionForm> {
  ...
  void initState() {
    ...
    if (widget.session != null) {
      ...
      // ✅ Load sectionId và sectionName từ session
      _selectedSectionId = widget.session!.sectionId;
      _selectedSectionName = widget.session!.sectionName ?? widget.session!.subjectName ?? '';
    }
  }
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Section selection
                  // ✅ Nếu đang edit, hiển thị readonly; nếu tạo mới, cho phép chọn
                  widget.session == null
