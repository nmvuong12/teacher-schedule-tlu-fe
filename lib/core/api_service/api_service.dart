// [api_service.dart] - ĐÃ SỬA LỖI ENDPOINT CHO getSessions()
import 'dart:async';
import 'dart:convert';
...
class ApiService {
  ...
  // ⭐️ [ĐÃ SỬA] ⭐️
  // Sửa hàm này để gọi /api/sessions/scheduled thay vì /api/sessions
  Future<List<dynamic>> getSessions() async {
    try {
      final response = await _dio.get('/sessions/scheduled'); //
      return response.data as List<dynamic>;
    } on DioException catch (e) {
